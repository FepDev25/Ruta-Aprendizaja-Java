...
public class EjemploStringMetodos {
    public static void main(String[] args) {
        ...
        System.out.println("nombre.equals(\"Felipe Peralta\") = " + nombre.equals("Felipe Peralta"));
        System.out.println("nombre.equals(\"felipe peralta\") = " + nombre.equals("felipe peralta"));
        System.out.println("nombre.equalsIgnoreCase(\"felipe peralta\") = " + nombre.equalsIgnoreCase("felipe peralta"));
        System.out.println("nombre.compareTo(\"\"Felipe Peralta\") = " + nombre.compareTo("Felipe Peralta"));
        System.out.println("nombre.compareTo(\"Diego Peralta\") = " + nombre.compareTo("Diego Peralta"));
