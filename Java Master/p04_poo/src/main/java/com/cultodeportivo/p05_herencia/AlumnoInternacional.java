...
public final class AlumnoInternacional extends Alumno {
    ...
    // AlumnoInternacional hereda de Alumno, quien a su vez hereda de Persona, 
    // por lo que AlumnoInternacional tiene todos los atributos y métodos de ambas clases.
